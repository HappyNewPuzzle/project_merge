...
builder.Services.AddScoped<GetInventoryService>();
builder.Services.AddScoped<TransferInventoryItemService>();
builder.Services.AddSingleton<GetContentCatalogService>();
